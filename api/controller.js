const { customer_signupSchema, agent_signupSchema, seller_signupSchema, forgotPassword_schema, signin_schema, checkOtp_schema, resetPassword_schema } = require('../validations/joi_validations');
const { customer_register, agent_register, seller_register, login, sendOtp, data_service, otpCheck, setPassword } = require('./services')
