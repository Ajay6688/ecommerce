...
const { customerSignup, agentSignup, sellerSignup, signin, getdata, forgotPassword, checkOtp, resetPassword } = require('./controller');
...
router.get('/get-data', checktoken, getdata)
